...
//     "afterbegin",
//     `<p>${publisher}: ${publishers[publisher]} games</p>`
//   );
// }

// videoGames.filter((game) => game.ratings.metacritic > 95).forEach((game) => document.querySelector(".games").insertAdjacentHTML("afterbegin", `<p>${game.title} - ));
